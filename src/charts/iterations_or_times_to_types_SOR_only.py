...
def draw_iterations_or_times_to_types_SOR_only(indicator: str, sor_data: list, types: list, ws: list) -> NoReturn:
...
def draw_iterations_to_types_SOR_only(sor_iterations: list, types: list, ws: list) -> NoReturn:
    draw_iterations_or_times_to_types_SOR_only(Y_ITERATIONS_INDICATOR, sor_iterations, types, ws)


def draw_times_to_types_SOR_only(sor_times: list, types: list, ws: list) -> NoReturn:
    draw_iterations_or_times_to_types_SOR_only(Y_TIMES_INDICATOR, sor_times, types, ws)
