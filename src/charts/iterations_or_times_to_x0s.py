...
def draw_iterations_or_times_to_x0s(
    indicator: str, jacobi_data: list, gauss_seidel_data: list, sor_data: list, x0s: list
) -> NoReturn:
...
def draw_iterations_to_x0s(
    jacobi_iterations: list, gauss_seidel_iterations: list, sor_iterations: list, x0s: list
) -> NoReturn:
    draw_iterations_or_times_to_x0s(
        Y_ITERATIONS_INDICATOR, jacobi_iterations, gauss_seidel_iterations, sor_iterations, x0s
    )


def draw_times_to_x0s(jacobi_times: list, gauss_seidel_times: list, sor_times: list, x0s: list) -> NoReturn:
    draw_iterations_or_times_to_x0s(Y_TIMES_INDICATOR, jacobi_times, gauss_seidel_times, sor_times, x0s)
